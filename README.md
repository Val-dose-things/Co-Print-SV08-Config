...
G1 X{first_layer_print_max[0]-90} Y{first_layer_print_max[1]+60} Z0.8 F6000.0 ; position 60mm behind print.
M104 S[nozzle_temperature_initial_layer] ;set extruder temp
M109 S[nozzle_temperature_initial_layer];wait for extruder temp
G1 E10 F600
M400
G92 E0.0 ; reset extruder
G1 X{first_layer_print_max[0]-70} Y{first_layer_print_max[1]+10} Z0.8 F6000.0 ; position 10mm behind print.
G1 X{first_layer_print_max[0]-120} Y{first_layer_print_max[1]+10} E80 F360.0 ; extrude 50mm of filament in the x direction
G92 E0.0 ; reset extruder
